...
// Custom Feature: Medication therapy management (MTM)
// Medication therapy management (MTM): Continuous review of patient med list; AI identifies deprescribing opportunities, duplicate therapies, cost-saving generics; generates MTM interventions
import React, { useState } from 'react';

export default function CFMedicationTherapyManagementMtmPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-medication-therapy-management-mtm/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Medication therapy management (MTM)</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Medication therapy management (MTM): Continuous review of patient med list; AI identifies deprescribing opportunities, duplicate therapies, cost-saving generics; generates MTM interventions</p>
