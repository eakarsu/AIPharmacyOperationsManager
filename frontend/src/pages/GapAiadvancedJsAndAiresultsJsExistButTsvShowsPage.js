...
const API_PATH = '/api/gap-aiadvanced-js-and-airesults-js-exist-but-tsv-shows';
const TITLE = "AI Stub Wiring";
const SUBTITLE = "aiAdvanced.js and aiResults.js exist but TSV shows 0 endpoints — stubs need wiring";

export default function GapAiadvancedJsAndAiresultsJsExistButTsvShowsPage({ token }) {
