...
const API_PATH = '/api/gap-no-webhooks-for-prescription-events';
const TITLE = "Rx Webhooks AI";
const SUBTITLE = "No webhooks for prescription events";

export default function GapNoWebhooksForPrescriptionEventsPage({ token }) {
