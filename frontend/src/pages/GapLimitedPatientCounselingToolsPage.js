...
const API_PATH = '/api/gap-limited-patient-counseling-tools';
const TITLE = "Patient Counseling AI";
const SUBTITLE = "Limited patient counseling tools";

export default function GapLimitedPatientCounselingToolsPage({ token }) {
