...
// Gap (Non-AI): Limited patient counseling tools
// Limited patient counseling tools
import React, { useState } from 'react';

export default function GapLimitedPatientCounselingToolsPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-limited-patient-counseling-tools/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Limited patient counseling tools</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Limited patient counseling tools</p>
