...
// No real-time sync with physician EHR/prescriber systems
import React, { useState, useEffect, useCallback } from 'react';

const API_PATH = '/api/gap-no-real';
const TITLE = "EHR Sync AI";
const SUBTITLE = "No real-time sync with physician EHR/prescriber systems";

export default function GapNoRealPage({ token }) {
