...
const API_PATH = '/api/gap-no-insurance-verification-automation';
const TITLE = "Insurance Verification AI";
const SUBTITLE = "No insurance verification automation";

export default function GapNoInsuranceVerificationAutomationPage({ token }) {
