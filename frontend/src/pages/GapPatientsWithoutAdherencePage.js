...
const API_PATH = '/api/gap-patients-without-adherence';
const TITLE = "Adherence Predict AI";
const SUBTITLE = "Patients without /adherence-predict (flag likely non-adherence; suggest interventions)";

export default function GapPatientsWithoutAdherencePage({ token }) {
