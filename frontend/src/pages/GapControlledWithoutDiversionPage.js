...
export default function GapControlledWithoutDiversionPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-controlled-without-diversion/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Controlled without '/diversion</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Controlled without /diversion-detect (flag suspicious prescribing patterns suggesting drug diversion)</p>
