...
const API_PATH = '/api/gap-controlled-without-diversion';
const TITLE = "Diversion Detection AI";
const SUBTITLE = "Controlled without /diversion-detect (flag suspicious prescribing patterns suggesting drug diversion)";

export default function GapControlledWithoutDiversionPage({ token }) {
