...
const API_PATH = '/api/gap-claims-without-claim';
const TITLE = "Claim Denial Predict AI";
const SUBTITLE = "Claims without /claim-denial-predict (predict if claim will be denied)";

export default function GapClaimsWithoutClaimPage({ token }) {
