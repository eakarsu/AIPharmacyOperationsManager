...
const API_PATH = '/api/gap-no-mobile-app-for-pharmacists-on-the-floor';
const TITLE = "Mobile Pharmacist AI";
const SUBTITLE = "No mobile app for pharmacists on the floor";

export default function GapNoMobileAppForPharmacistsOnTheFloorPage({ token }) {
