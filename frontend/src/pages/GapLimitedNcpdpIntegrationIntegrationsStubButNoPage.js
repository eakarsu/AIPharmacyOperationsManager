...
const API_PATH = '/api/gap-limited-ncpdp-integration-integrations-stub-but-no';
const TITLE = "NCPDP Integration AI";
const SUBTITLE = "Limited NCPDP integration (integrations stub but no real network adapter)";

export default function GapLimitedNcpdpIntegrationIntegrationsStubButNoPage({ token }) {
