...
const API_PATH = '/api/gap-inventory-without-reorder';
const TITLE = "Reorder Predict AI";
const SUBTITLE = "Inventory without /reorder-predict (demand forecasting)";

export default function GapInventoryWithoutReorderPage({ token }) {
