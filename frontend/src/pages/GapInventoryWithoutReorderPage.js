...
export default function GapInventoryWithoutReorderPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-inventory-without-reorder/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Inventory without '/reorder</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Inventory without /reorder-predict (demand forecasting)</p>
